...
var TestsListPage = /** @class */ (function () {
    function TestsListPage(navCtrl, navParams, testsService, quizService, getImage, loadingCtrl) {
        ...
        if (calledFrom == 'services') {
            ...
            alert("test is " + localStorage.getItem("downloadedTests"));
