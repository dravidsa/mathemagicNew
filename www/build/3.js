...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_tests_service_tests_service__ = __webpack_require__(238);
...
var TestsListPage = /** @class */ (function () {
    ...
    TestsListPage.prototype.transformQuestion = function (questions, getImage, testid, nav, loading) {
        return __awaiter(this, void 0, void 0, function () {
            var ImageMap, imageURLArr, serviceCounter, matchCount, strMatch, imgURL, gifoffset, base64data, i, text, matches, matches, matches, matches, matches;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(i < questions.length)) return [3 /*break*/, 17];
                    ...
                    case 13:
                        ...
                        ;
                        if (!text.match(/<img src=...*?.gif[ ]*...*\/>/g)) return [3 /*break*/, 15];
                        console.log(" find match in q " + i + text.match(/<img src=...*?.gif[ ]*/g) + "XXX");
                        matches = text.match(/<img src=...*?.gif[ ]*...*\/>/g).toString().split(',');
                        //console.log( "matches are " + matches.length + matches[0]  ) ; 
                        strMatch = matches[0];
