...
var LoginPage = /** @class */ (function () {
    function LoginPage(nav, auth, courses, alertCtrl, loadingCtrl) {
        var _this = this;
        this.nav = nav;
        this.auth = auth;
        ...
        this.registerCredentials = { username: 'sandra', password: 'sandeep123' };
